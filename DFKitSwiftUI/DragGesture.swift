...
public enum DragGesturePhase: CustomStringConvertible, Sendable, Hashable {
    case started
    ...
    public var description: String {
        switch self {
        case .started:
            return "DragGesturePhase.started"
        case let .changed(value):
            return "DragGesturePhase.changed(value: \(value))"
        case let .ended(value):
            return "DragGesturePhase.ended(value: \(value))"
        }
    }
}
